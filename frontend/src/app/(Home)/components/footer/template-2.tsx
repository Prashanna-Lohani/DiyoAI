...
export function FooterTemplate2() {
  return (
    <footer className="bg-secondary/10">
      <div className="mx-auto max-w-360 px-6 py-16 md:px-8 lg:px-12">
        <div className="rounded-[2.5rem] border-2 border-white bg-white p-8 shadow-xl md:p-12">
          <div className="grid grid-cols-1 gap-12 md:grid-cols-3 lg:gap-16">
            ...
            <div className="flex flex-col gap-3">
              ...
              >
                ...
                <Button
                  type="submit"
                  className="shrink-0 rounded-full bg-secondary px-5 text-secondary-foreground hover:bg-secondary/80"
                >
                  Submit
                </Button>
              </form>
          ...
          <div className="mt-16 flex flex-col-reverse items-center justify-between gap-6 border-t-2 border-border pt-8 sm:flex-row">
