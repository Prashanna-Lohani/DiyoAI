  ...
  return (
    <section className="overflow-hidden bg-muted/30 py-20 lg:py-24">
      <FadeIn className="mx-auto max-w-300 px-6 text-center md:px-8 lg:px-12">
        ...
        <p className="mt-10 text-xs font-medium tracking-widest text-muted-foreground uppercase">
        ...
        <Marquee
          ...
          renderItem={(collaborator) => (
            <div className="flex w-32 flex-col items-center gap-3 text-center">
              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-white p-3 shadow-sm">
                <Image
